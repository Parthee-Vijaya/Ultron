...
enum BuiltInModes {
    ...
    static let chat = Mode(
        ...
        name: "Chat",
        systemPrompt: """
        Du er Ultron, en hjælpsom AI-assistent. Svar præcist og hjælpsomt på brugerens besked. \
    ...
    static let all: [Mode] = [dictation, vibeCode, professional, qna, vision, chat, translate, summarize, agent, ollamaAgent]
}
