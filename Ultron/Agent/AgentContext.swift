...
final class AgentContext {
    ...
    /// user's Desktop + Downloads + ~/Documents/Ultron for safety.
    ...
    static func defaultAllowedRoots() -> [URL] {
        ...
        return [
            ...
            home.appendingPathComponent("Documents/Ultron")
        ]
    }
...
enum AgentError: LocalizedError, Sendable {
    ...
    var errorDescription: String? {
        ...
        case .outsideWorkspace(let path):
            return "Stien '\(path)' ligger uden for Ultron' tilladte arbejdsområde. Tilføj den under Settings → Agent → Allowed roots hvis du vil tillade adgang."
