...
enum SyntaxHighlighter {
    static func highlight(_ source: String, language: String) -> AttributedString {
        ...
        attributed.foregroundColor = JarvisTheme.textPrimary
    ...
    private enum Colors {
        ...
        static let comment: Color = JarvisTheme.textMuted
        static let number:  Color = Color(red: 0.95, green: 0.67, blue: 0.35)  // amber
        static let type:    Color = JarvisTheme.accent                          // Jarvis cyan/amber accent
    }
